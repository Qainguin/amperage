<script lang="ts">
	import { createProjectFromDirectory, createProjectFromTemplate, createProjectFromRepo } from '$lib/creator';
...
<main class="h-screen w-screen overflow-hidden font-mono text-editor-foreground">
	<div class="m-8 flex flex-col">
		...
		<button
			...
			onclick={async () => {
				...
				const url = prompt("Enter the URL of the repository you would like to clone.");
